...
try {
  ...
  const isAutoGeneratedMessage = core.getBooleanInput('auto-generated-message')
  const isEmbed = core.getBooleanInput('embed')
  ...
  const message = isAutoGeneratedMessage ? makeMessage(core, context) : messageInput
