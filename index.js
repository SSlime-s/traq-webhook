...
async function main() {
	...
	core.debug(`messageInput: ${messageInput}`);
	core.debug(`isAutoGeneratedMessage: ${isAutoGeneratedMessage}`);
	core.debug(`isEmbed: ${isEmbed}`);
	...
	core.debug(`will send message: ${message}`);
